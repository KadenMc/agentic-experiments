...
from aexp.schema import ArtifactKind, LiminaArtifactRef
...
def _load_artifact(path: Path, kb_root: Path) -> LiminaArtifactRef:
...
def load_artifact(artifact_id: str, *, kb_root: Path) -> LiminaArtifactRef:
...
def load_hypothesis(artifact_id: str, *, kb_root: Path) -> LiminaArtifactRef:
...
def load_experiment(artifact_id: str, *, kb_root: Path) -> LiminaArtifactRef:
...
def load_finding(artifact_id: str, *, kb_root: Path) -> LiminaArtifactRef:
...
def list_kb_artifacts(
    ...
    *,
    ...
    results: list[LiminaArtifactRef] = []
    for k in kinds:
